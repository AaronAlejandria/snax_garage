...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'WrongEmailPage',
          path: '/wrongEmailPage',
          builder: (context, params) => const WrongEmailPageWidget(),
        ),
        FFRoute(
          name: 'PasswordChangeSuccessPage',
          path: '/passwordChangeSuccessPage',
          builder: (context, params) => const PasswordChangeSuccessPageWidget(),
        ),
        FFRoute(
          name: 'WelcomePage',
          path: '/welcomePage',
        ...
        FFRoute(
          name: 'template',
          path: '/template',
          builder: (context, params) => const TemplateWidget(),
        ),
        FFRoute(
          name: 'ManageProductPage',
          path: '/manageProductPage',
          builder: (context, params) => const ManageProductPageWidget(),
        ),
        FFRoute(
          name: 'AddProductPage',
          path: '/addProductPage',
        ...
        FFRoute(
          name: 'SalesOverview',
          path: '/salesOverview',
          builder: (context, params) => const SalesOverviewWidget(),
        ),
        FFRoute(
