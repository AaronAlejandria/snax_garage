...
import 'manage_product_page_model.dart';
export 'manage_product_page_model.dart';

class ManageProductPageWidget extends StatefulWidget {
  const ManageProductPageWidget({super.key});

  @override
  State<ManageProductPageWidget> createState() =>
      _ManageProductPageWidgetState();
}

class _ManageProductPageWidgetState extends State<ManageProductPageWidget> {
  late ManageProductPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageProductPageModel());
  }
