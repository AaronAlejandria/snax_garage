...
import '/components/adding_product_confirmation/adding_product_confirmation_widget.dart';
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .price2TextController,
                                                    focusNode:
                                                        _model.price2FocusNode,
                                                    autofocus: false,
                                                    obscureText: false,
                                                    decoration: InputDecoration(
                                                      isDense: true,
                                    ...
                                    onPressed: () async {
                                      if (_model.size == true) {
                                        ...
                                        _model.price1 = double.tryParse(
                                            _model.price1TextController.text);
                                        _model.price2 = double.tryParse(
                                            _model.price2TextController.text);
                                        _model.subCatId =
                                          ...
                                          return GestureDetector(
                                            ...
                                            child: Padding(
                                              padding: MediaQuery.viewInsetsOf(
                                                  context),
                                              child:
                                                  AddingProductConfirmationWidget(
                                                name: _model.name!,
                                                subCategoryId: _model.subCatId!,
