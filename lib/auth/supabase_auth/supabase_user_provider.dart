...
class SnaxGarageSupabaseUser extends BaseAuthUser {
  SnaxGarageSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> snaxGarageSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SnaxGarageSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
